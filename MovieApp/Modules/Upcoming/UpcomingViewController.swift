...
class UpcomingViewController: UIViewController {
    ...
    init(presenter: UpcomingPresenter) {
...
extension UpcomingViewController {
    private func setupView() {
        title = "general.upcoming".localized
        setupCollectionView()
    }
...
extension UpcomingViewController: UICollectionViewDataSource, UICollectionViewDelegateFlowLayout {
...
extension UpcomingViewController: SkeletonCollectionViewDataSource {
